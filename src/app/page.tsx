...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const runSequence = async () => {
      ...
      await animate("#hello", {opacity: 1, y:50}, {duration: 1.7});
      // Step 2: Fade in My name
      await animate("#intro-text", { opacity: 1, y:70 }, { duration: 0.6});
  ...
  return (
    <main className="flex flex-col items-center justify-start pt-50 -min-h-screen relative" ref={scope}>
  ...
  <div className="absolute top-[97%] left-1/2 -translate-x-1/2 mt-4 z-0">
    <motion.img
      id="photo"
      src="/images/tempPic.png"
      alt="Gabriel"
      initial={{ opacity: 0, scale: 0.8, y: -10 }}
      className="w-60 h-60 rounded-full border-2 border-blue-500"
    />
